...
import com.intel.hadoop.hbase.dot.mapreduce.DotTsvImporterMapper;
 ...
 *
 * @see DotImportTsv#usage(String)
 */
public class DotImportTsv {
  final static String NAME = "dotimporttsv";
  ...
  final static Class DEFAULT_MAPPER = DotTsvImporterMapper.class;
